  ...
  return (
    <div className="grid h-svh w-full place-content-center bg-black">
      <div className="border-shadow h-[315px] w-[600px] bg-[#3257D1] p-4">
        ...
        <div className="font-ioskeley-mono flex w-full items-center justify-between text-right text-7xl font-bold text-[#FEF5E2]">
          <div className="mt-auto mb-1 ml-1 flex items-end gap-1 text-xl text-[#FEF] opacity-70">
            UOY STUDENT
          </div>{" "}
          <div>ENGINEER</div>
        </div>
